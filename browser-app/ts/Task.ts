...
/**
 * typeof statusMap => {todo: 'TODO', doing: 'DOING', done: 'DONE'}型
 * keyof typeof statusMap => 'todo' | 'doing' | 'done'ユニオン型
 * typeof statusMap[keyof typeof statusMap] => 'TODO' | 'DOING' | 'DONE'ユニオン型
 */
